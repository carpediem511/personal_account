...
/*export const metadata = {
	title: "О сервисе",
	description: "Узнайте больше о Momentum – вашем цифровом помощнике для управления финансами и повседневными делами. Наша миссия – помогать вам достигать целей и наслаждаться жизнью, предоставляя удобные и эффективные инструменты. Откройте для себя, что делает нас уникальными.",
};*/
